...
<div class="container-fluid mt--6">
        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-header border-0">
                    <button type="button" onclick="addSimpananSukarela()" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Simpanan Sukarela</button>
                </div>
                <!-- Light table -->
                <div class="tab-content mb-2" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="semua_simpanan_pokok" role="tabpanel">
                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush" id="table_semua_simpanan_sukarela" style="width: 100%;">
                                <thead class="thead-light">
                                    <tr>
                                        <th class="text-center">No</th>
                                        <th class="text-center">Tanggal</th>
                                        <th class="text-center">Kode Simpanan Sukarela</th>
                    ...
                    <div class="tab-pane fade" id="riwayat" role="tabpanel">
                        <p class="text-warning fs-4 pl-4" style="font-weight: bold;">Riwayat Simpanan Sukarela</p>
                        <div class="table-responsive">
    ...
    <div class="modal fade" id="simpananSukarelaModal" tabindex="-1" aria-labelledby="simpananSukarelaModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="simpananSukarelaModalLabel">Modal title</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="" method="POST" id="form_simpanan_sukarela">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="id_anggota" name="id_anggota" readonly>
                            <div class="text-danger" id="id_anggota_error"></div>
                        </div>
                ...
                <div class="modal-footer">
                    <button type="button" id="cancel_simpanan_sukarela" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button type="button" id="submit_simpanan_sukarela" class="btn btn-primary">Save changes</button>
                </div>
                </form>
            </div>
        </div>
    ...
    <!-- Modal -->
    <script src="<?= base_url() ?>js/simpanan_sukarela.js"></script>