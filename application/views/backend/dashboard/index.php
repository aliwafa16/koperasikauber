                ...
                <div class="card bg-default">
                    <div class="card-header bg-transparent">
                        <div class="row align-items-center">
                            <div class="col">
                                <h6 class="text-light text-uppercase ls-1 mb-1">Rekap Jumlah Kendaraan</h6>
                                <h5 class="h3 text-white mb-0">Jumlah Kendaraan</h5>
                            </div>
                            <div class="col">
            ...
            <div class="col-xl-4">
                <div class="card">
                    <div class="card-header bg-transparent">
                        <div class="row align-items-center">
                            <div class="col">
                                <h6 class="text-uppercase text-muted ls-1 mb-1">Rekap Jenis Kelamin</h6>
                                <h5 class="h3 mb-0">Anggota Koperasi</h5>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
